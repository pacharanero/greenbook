 ...
 *
 * It reads:
 *   - rules/schedule-uk-2026-01-01.toml     (the schedule)
 *   - rules/product-map-uk-snomed-dm.toml   (the product -> class/antigens map)
...
const SCHEDULE = join(repo, 'rules', 'schedule-uk-2026-01-01.toml');
const PRODUCTS = join(repo, 'rules', 'product-map-uk-snomed-dm.toml');
